...
public class StateTest {
    ...
    public static class MyFlatMap extends RichFlatMapFunction<Event, String>{
        ...
        AggregatingState<Event, String> myAggregationState;
        ...
        public void open(Configuration parameters) throws Exception {
            ...
            myReducingState = getRuntimeContext().getReducingState(new ReducingStateDescriptor<Event>("my-reduce",
                    ...
                    , Event.class));
            myAggregationState = getRuntimeContext().getAggregatingState(new AggregatingStateDescriptor<Event, Long, String>("my-agg",
        ...
        public void flatMap(Event value, Collector<String> out) throws Exception {
            ...
            myAggregationState.add(value);
            System.out.println("my agg state: " + myAggregationState.get());
